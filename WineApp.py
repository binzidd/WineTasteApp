...
model_acc_ds1=round(accuracy_score(val_y1, val_predict1)*100,0)
...
RF_Dep = st.slider('How many trees do you want in this forest?', 100, 300, 250, key="RF_D")
...
model_acc_rf=round(accuracy_score(val_y4, val_predict4)*100,0)
